...
function roles(users) {
    ...
    function logRoles() {
        console.log("Admin: " + rolesuser.admin);
        console.log("Moderator: " + rolesuser.moderator);
        console.log("User: " + rolesuser.user);
    }
...
const accountings = () => {
    let person = users
        .filter(user => user.company.department === "Accounting"); 
